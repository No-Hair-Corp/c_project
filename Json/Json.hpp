...
enum JsonErrorCodes { JSON_SUCCESS, JSON_FILE_READ_ERROR, JSON_INTEGRITY_ERROR, JSON_NB_SIGNAL_ERROR,
    JSON_PREPARE_ERROR, JSON_SIMPLIFY_ERROR};
...
class Json {
    ...
    public:
        ...
        static int printJson(const string& file_path, set<Stimulus*> stimuli, bool overwrite);
