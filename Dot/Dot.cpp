...
int Dot::parse() {
    string* current_state = "SB";
    string* next_state = nullptr;
    ...
    while (*next_state != "SE"){
        ...
        {
            case "SB":
                if (current_token->getType() == "StarterKeyWords"){
                    *next_state = 2;
                    current_token = current_token->getNextToken();
                }
                break;
            case "S0":
                if (current_token->getType() == "AnyWords" && current_token->getNextToken()->getValue() == "{"){
                    *next_state = "S1";
                    current_token = current_token->getNextToken()->getNextToken();
            ...
            case "S1":
                if(current_token->getType() == "AnyWords"){
                    temp_schem = SchematicObject(current_token->getType());
                    if(current_token->getNextToken()->getValue() == "["){
